...
namespace CPC_Report_Summary
{
    class Program
    {
        ...
        public static void AnalyzeDailyLoadedPerQuota(Microsoft.Office.Interop.Excel.Application xlApp, string mySampleFilePath)
        {
            ...
            All_Loaded_Summary_Sheet.Name = "All_Loaded_Summary_Sheet";
            ...
            //Header
            All_Loaded_Summary_Sheet.Range["A1:P1"].MergeCells = true;
            All_Loaded_Summary_Sheet.Range["A1"].HorizontalAlignment = XlHAlign.xlHAlignCenter;
            All_Loaded_Summary_Sheet.Range["A1"].VerticalAlignment = XlVAlign.xlVAlignCenter;
            All_Loaded_Summary_Sheet.Range["A1:P1"].Value = "ALL LOADED BROKEN DOWN BY (QUOTA CELLS AND DATE OF IMPORT)";
            ...
            All_Loaded_Summary_Sheet.Range["A1:P2"].Interior.Color = currentColor;
            All_Loaded_Summary_Sheet.Range["A1:P2"].Font.Bold = true;
            All_Loaded_Summary_Sheet.Range["A2:P2"].ColumnWidth = "10";
            All_Loaded_Summary_Sheet.Range["A2:P2"].Font.Name = "Verdana";
            All_Loaded_Summary_Sheet.Range["A2:P2"].Font.Size = "10";
            currentColor = System.Drawing.Color.FromArgb(100, 255, 255);
            All_Loaded_Summary_Sheet.Range["A1:P2"].Font.Color = currentColor;
            //update last row number
            int summaryLastRow = 0;
            summaryLastRow = getLastRowNumberWithValues(All_Loaded_Summary_Sheet, "A");
            //SORT ASCENDING (TO ABSTACTIFY)
            if (summaryLastRow > 3)
            {
            ...
            //FORMULAS
            All_Loaded_Summary_Sheet.Range["B3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,B$2)";
            All_Loaded_Summary_Sheet.Range["C3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,C$2)";
            All_Loaded_Summary_Sheet.Range["D3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,D$2)";
            All_Loaded_Summary_Sheet.Range["E3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,E$2)";
            All_Loaded_Summary_Sheet.Range["F3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,F$2)";
            All_Loaded_Summary_Sheet.Range["G3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,G$2)";
            All_Loaded_Summary_Sheet.Range["H3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,H$2)";
            All_Loaded_Summary_Sheet.Range["I3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,I$2)";
            All_Loaded_Summary_Sheet.Range["J3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,J$2)";
            All_Loaded_Summary_Sheet.Range["K3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,K$2)";
            All_Loaded_Summary_Sheet.Range["L3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,L$2)";
            All_Loaded_Summary_Sheet.Range["M3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,M$2)";
            All_Loaded_Summary_Sheet.Range["N3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,N$2)";
            All_Loaded_Summary_Sheet.Range["O3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,O$2)";
            All_Loaded_Summary_Sheet.Range["P3"].Formula = "=COUNTIFS('" + DataFile_SHEET.Name + "'!H:H,$A3,'" + DataFile_SHEET.Name + "'!U:U,P$2)";
            ...
            All_Loaded_Summary_Sheet.Range["A2:P" + (summaryLastRow + 1)].HorizontalAlignment = XlHAlign.xlHAlignCenter;
            All_Loaded_Summary_Sheet.Range["A2:P" + (summaryLastRow + 1)].VerticalAlignment = XlVAlign.xlVAlignCenter;
            ...
            All_Loaded_Summary_Sheet.Range["A3:P" + summaryLastRow].Font.Color = currentColor;
            ...
            All_Loaded_Summary_Sheet.Range["A1:P" + (summaryLastRow + 1)].Copy();
            All_Loaded_Summary_Sheet.Range["A1:P" + (summaryLastRow + 1)].PasteSpecial(Microsoft.Office.Interop.Excel.XlPasteType.xlPasteValues, Microsoft.Office.Interop.Excel.XlPasteSpecialOperation.xlPasteSpecialOperationNone, System.Type.Missing, System.Type.Missing);
            All_Loaded_Summary_Sheet.Range["A" + (summaryLastRow + 1) + ":P" + (summaryLastRow + 1)].Font.Bold = true;
            currentColor = System.Drawing.Color.FromArgb(35, 45, 55);
            All_Loaded_Summary_Sheet.Range["A" + summaryLastRow + 1 + ":P" + (summaryLastRow + 1)].Interior.Color = currentColor;
            currentColor = System.Drawing.Color.FromArgb(100, 255, 255);
            All_Loaded_Summary_Sheet.Range["A" + (summaryLastRow + 1) + ":P" + (summaryLastRow + 1)].Font.Color = currentColor;
            All_Loaded_Summary_Sheet.Range["A" + (summaryLastRow + 1) + ":P" + (summaryLastRow + 1)].Font.Name = "Verdana";
            All_Loaded_Summary_Sheet.Range["A" + (summaryLastRow + 1) + ":P" + (summaryLastRow + 1)].Font.Size = "10";
            ...
            All_Loaded_Summary_Sheet.Range["A1"].Select();
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter the NUMBER of week periods in " + projectCode + ":");
            weekPeriod = Console.ReadLine();
            Console.WriteLine("Enter the CURRENT week preiod in " + projectCode + ":");
            currentWeek = Console.ReadLine();

            Console.WriteLine("CHECK CODING FILE [1] | CHECK REPORT [2] | RAW SAMPLE PROVIDED PER QUOTA [3] | LOADED SAMPLE PER QUOTA [4]. Choose an option:");
            programMode = Console.ReadLine();

            string DataFilePathName_CD24 = @"\\CC3-MGMT2\EXPORT\" + projectCode + @"\Weekly Data Report " + projectCode + "_" + dateTodayString + ".xlsx";
            string CodingFilePathName_CD24 = @"\\CC3-MGMT2\EXPORT\" + projectCode + @"\" + projectCode + " " + dateTodayString + " Coding week " + currentWeek + " of " + weekPeriod + ".xlsx";
            ...
            if (programMode == "3")
            {
                ...
                try
                {
                    logSampleFileContent = System.IO.File.ReadAllLines(@"\\CC3-MGMT2\EXPORT\" + projectCode + @"\" + projectCode + @"_RawSampleBreakdownByQuota_Log.txt");
                }
                catch
                {
                ...
                foreach (string logCodingFileLine in logSampleFileContent)
                {
                    currentSampleFileLogDetails += (logCodingFileLine + "\r\n");
                }
                System.IO.StreamWriter logFile = new System.IO.StreamWriter(@"\\CC3-MGMT2\EXPORT\" + projectCode + @"\" + projectCode + @"_RawSampleBreakdownByQuota_Log.txt");
                logFile.WriteLine((currentSampleFileLogDetails + mSampleFileDetailLog));
                logFile.Close();
            ...
            if (programMode == "1")
            {
                CPC_Coding_Summary(xlApp, CodingFilePathName_CD24);
                ...
                System.IO.StreamWriter logFile = new System.IO.StreamWriter(@"\\CC3-MGMT2\EXPORT\" + projectCode + @"\" + projectCode + @"_Coding_Log.txt");
                logFile.WriteLine((currentCodingLogDetails + mCodingDetailLog));
                logFile.Close();
            ...
            if (programMode == "2")
            {
                try
                {
                    ...
                    //MAIN FUNCTION
                    CPC_Coding_Summary(xlApp, CodingFilePathName_CD24);
                    CPC_Report_Summary(xlApp, DataFilePathName_CD24);
                    ...
                    System.IO.StreamWriter logFile = new System.IO.StreamWriter(@"\\CC3-MGMT2\EXPORT\" + projectCode + @"\" + projectCode + @"_Report_Log.txt");
                    logFile.WriteLine((currentLogDetails + mReportDetailLog));
                    logFile.Close();
